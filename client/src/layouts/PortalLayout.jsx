    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          >
            ...
            <div className="text-left">
              <p className="text-sm font-medium text-gray-800 leading-none">{SALON_INFO.name}</p>
      ...
      <footer className="border-t border-gray-100 bg-white mt-8">
        <div className="max-w-2xl mx-auto px-4 py-4 text-center space-y-1">
          <p className="text-xs text-gray-400">{SALON_INFO.hours.weekdays} · {SALON_INFO.hours.saturday}</p>
          <p className="text-xs text-gray-400">{SALON_INFO.instagram} · {SALON_INFO.phone}</p>
        </div>
      </footer>
    </div>
  )
