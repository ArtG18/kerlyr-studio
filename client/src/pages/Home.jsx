...
const GALLERY = [
  ...
  { src: '/gallery/foto7.jpeg',   label: 'Francesa roja' },
  { src: '/gallery/foto8.jpeg',   label: 'Extensión francesa' },
    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm border-b border-rose-100">
        <div className="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a
              href="https://www.instagram.com/kerlyr_nailstudio/"
      ...
      {/* ── HERO ───────────────────────────────────────────────────────── */}
      <section className="pt-20 min-h-screen flex items-center bg-gradient-to-br from-rose-50 via-white to-pink-50">
        <div className="max-w-6xl mx-auto px-6 py-20 grid grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-3 h-96">
            <div className="rounded-3xl overflow-hidden shadow-xl">
              <img src="/gallery/foto12.jpg" alt="Nail art" className="w-full h-full object-cover" />
            </div>
            <div className="grid grid-rows-2 gap-3">
              <div className="rounded-2xl overflow-hidden shadow-lg">
                <img src="/gallery/foto4.jpeg" alt="Nail art" className="w-full h-full object-cover" />
              </div>
              <div className="rounded-2xl overflow-hidden shadow-lg">
                <img src="/gallery/foto9.jpeg" alt="Nail art" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-3 gap-6">
            {SERVICES_PREVIEW.map(svc => (
              <div key={svc.label} className="group p-6 rounded-2xl border border-rose-100 hover:border-rose-300 hover:shadow-lg hover:shadow-rose-50 transition-all duration-200 cursor-pointer"
                onClick={() => navigate('/portal')}>
        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-2 gap-16 items-center">
          <div className="relative">
            <div className="grid grid-cols-2 gap-3">
              <img src="/gallery/foto5.jpeg" alt="" className="rounded-2xl shadow-lg object-cover h-52 w-full" />
              <img src="/gallery/foto8.jpeg" alt="" className="rounded-2xl shadow-lg object-cover h-52 w-full mt-8" />
              <img src="/gallery/foto1.jpeg" alt="" className="rounded-2xl shadow-lg object-cover h-52 w-full -mt-4" />
              <img src="/gallery/foto7.jpeg" alt="" className="rounded-2xl shadow-lg object-cover h-52 w-full mt-4" />
            </div>
            <div className="absolute -bottom-4 -right-4 bg-white rounded-2xl p-4 shadow-xl border border-rose-100">
          ...
          <div>
              ...
              {[
                ...
                <div key={item} className="flex items-center gap-3">
                  <div className="w-5 h-5 rounded-full bg-rose-100 flex items-center justify-center flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-3 h-3 text-rose-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex gap-3">
              <div className="bg-white rounded-xl px-4 py-3 border border-rose-100 text-center">
                <p className="text-xs text-gray-400">Lun–Vie</p>
                <p className="text-sm font-semibold text-gray-800">10:00–19:00</p>
              </div>
              <div className="bg-white rounded-xl px-4 py-3 border border-rose-100 text-center">
                <p className="text-xs text-gray-400">Sábado</p>
                <p className="text-sm font-semibold text-gray-800">10:00–14:00</p>
              </div>
              <div className="bg-white rounded-xl px-4 py-3 border border-rose-100 text-center">
                <p className="text-xs text-gray-400">Domingo</p>
      ...
      <section id="galeria" className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 mt-2">Haz clic en cualquier foto para verla completa</p>
          </div>
          <div className="grid grid-cols-4 gap-4">
            {GALLERY.map((img, i) => (
              <button
                ...
                className="group relative rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 hover:scale-105 aspect-square"
              >
                <img
                  src={img.src}
                  alt={img.label}
      ...
      <section className="py-20 bg-gradient-to-r from-rose-400 to-pink-500">
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <p className="text-rose-100 mb-8 text-lg">
            Agenda tu cita en minutos y elige el horario que más te acomode.
          </p>
          <button
            onClick={() => navigate('/portal')}
          ...
          <div className="flex items-center justify-center gap-6 mt-10">
            <a href="https://wa.me/56959257968" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 text-white/80 hover:text-white transition-colors text-sm">
              📱 +56 9 5925 7968
            </a>
            <span className="text-rose-300">·</span>
            <a href="https://www.instagram.com/kerlyr_nailstudio/" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 text-white/80 hover:text-white transition-colors text-sm">
              📸 @kerlyr_nailstudio
            </a>
            <span className="text-rose-300">·</span>
            <a href="https://maps.app.goo.gl/HcRbJ1P2bLscUEGL8" target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2 text-white/80 hover:text-white transition-colors text-sm">
              📍 Ver ubicación
            </a>
          </div>
      ...
      {lightbox && (
        ...
        >
          <div className="relative max-w-2xl w-full" onClick={e => e.stopPropagation()}>
            ...
            <button
              onClick={() => setLightbox(null)}
              className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-white text-gray-800 flex items-center justify-center font-bold shadow-lg hover:bg-gray-100"
            >
              ×
            </button>
          </div>
